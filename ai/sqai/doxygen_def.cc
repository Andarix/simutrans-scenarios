...
/** @file doxygen_def.cc Documents the necessary functions to be implemented by a script */

// It is in a C++ file to be processed by Doxygen filters to get function typemasks right


/**
 * This function calculates a ratio of street vehicles (player and city vehicles) to the size of the map.
 * The result is used when calling the traffic jam test for road vehicles.
 * @return true or false
 * @ typemask bool(integer)
 * @ ingroup
 */
register_function("set_map_vehicles_counts");

/**
 * This function determines whether the construction costs are less than the available capital.
 *
 * @ typemask bool
 * @ ingroup
 */
register_function("is_cash_available");
